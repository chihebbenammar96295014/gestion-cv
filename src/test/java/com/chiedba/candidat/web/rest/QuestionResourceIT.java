...
import com.chiedba.candidat.repository.QuestionRepository;
import com.chiedba.candidat.service.dto.QuestionDTO;
import com.chiedba.candidat.service.mapper.QuestionMapper;
...
class QuestionResourceIT {
    ...
    private static final String DEFAULT_REPONSE_CORRECTE = "AAAAAAAAAA";
    private static final String UPDATED_REPONSE_CORRECTE = "BBBBBBBBBB";
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().order(DEFAULT_ORDER).question(DEFAULT_QUESTION).reponseCorrecte(DEFAULT_REPONSE_CORRECTE);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().order(UPDATED_ORDER).question(UPDATED_QUESTION).reponseCorrecte(UPDATED_REPONSE_CORRECTE);
        return question;
    }
    ...
    void createQuestion() throws Exception {
        ...
        assertThat(testQuestion.getReponseCorrecte()).isEqualTo(DEFAULT_REPONSE_CORRECTE);
    }
    ...
    @Test
    @Transactional
    void checkReponseCorrecteIsRequired() throws Exception {
        int databaseSizeBeforeTest = questionRepository.findAll().size();
        // set the field null
        question.setReponseCorrecte(null);
    ...
    void getAllQuestions() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.[*].reponseCorrecte").value(hasItem(DEFAULT_REPONSE_CORRECTE)));
    }
    ...
    void getQuestion() throws Exception {
        ...
        restQuestionMockMvc
            ...
            .andExpect(jsonPath("$.reponseCorrecte").value(DEFAULT_REPONSE_CORRECTE));
    }
    ...
    void putExistingQuestion() throws Exception {
        ...
        updatedQuestion.order(UPDATED_ORDER).question(UPDATED_QUESTION).reponseCorrecte(UPDATED_REPONSE_CORRECTE);
        ...
        assertThat(testQuestion.getReponseCorrecte()).isEqualTo(UPDATED_REPONSE_CORRECTE);
    }
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.order(UPDATED_ORDER).question(UPDATED_QUESTION).reponseCorrecte(UPDATED_REPONSE_CORRECTE);
