...
import com.chiedba.candidat.service.AppUserService;
...
/**
 * REST controller for managing {@link com.chiedba.candidat.domain.AppUser}.
 */
@RestController
@RequestMapping("/api")
public class AppUserResource {
    ...
    public ResponseEntity<List<AppUserDTO>> getAllAppUsers(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
