...
describe('Resume Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'resume', component: ResumeComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to resumeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getResumeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getResumeIdentifier).toHaveBeenCalledWith(entity);
