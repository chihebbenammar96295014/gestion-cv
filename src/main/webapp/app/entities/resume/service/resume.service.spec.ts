...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../resume.test-samples';

import { ResumeService } from './resume.service';

const requireRestSample: IResume = {
...
describe('Resume Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Resume', () => {
      ...
      const resume = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(resume).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Resume', () => {
      const resume = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(resume).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addResumeToCollectionIfMissing', () => {
      it('should add a Resume to an empty array', () => {
        const resume: IResume = sampleWithRequiredData;
      ...
      it("should add a Resume to an array that doesn't contain it", () => {
        const resume: IResume = sampleWithRequiredData;
        const resumeCollection: IResume[] = [sampleWithPartialData];
        expectedResult = service.addResumeToCollectionIfMissing(resumeCollection, resume);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(resume);
      });
      ...
      it('should add only unique Resume to an array', () => {
        const resumeArray: IResume[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const resumeCollection: IResume[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const resume: IResume = sampleWithRequiredData;
        const resume2: IResume = sampleWithPartialData;
    ...
    describe('compareResume', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareResume(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareResume(entity1, entity2);
        const compareResult2 = service.compareResume(entity2, entity1);
